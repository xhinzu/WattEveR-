    ...
    <div className="min-h-screen bg-slate-100 text-slate-700 flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white border border-slate-200 shadow-xl rounded-2xl p-6 relative overflow-hidden">
        ...
        <div className="flex flex-col items-center text-center mt-2 mb-6">
          ...
          <h2 className="text-xl font-extrabold mt-3 tracking-tight text-slate-900">
            WattEveR Grid Portal
          </h2>
          <p className="text-xs text-slate-500 mt-1">Utility Operations & Telemetry Center</p>
        </div>

        {/* Error Alert */}
        {error && (
          <div className="mb-4 p-3 rounded-lg bg-red-50 border border-red-200 flex items-start space-x-2 text-red-600 text-xs">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          <div>
            <label className="block text-[11px] font-semibold text-slate-500 uppercase tracking-wider mb-1">Worker Email</label>
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 rounded-lg border border-slate-300 text-slate-800 text-sm focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition"
                disabled={loading}
              />
            </div>
          </div>
          ...
          <div>
            <label className="block text-[11px] font-semibold text-slate-500 uppercase tracking-wider mb-1">Security Password</label>
            <div className="relative">
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-xs">
            <span className="bg-white px-2 text-slate-400">Operator Sandbox</span>
          </div>
        </div>
        ...
        <button
          ...
          disabled={loading}
          className="w-full py-2 rounded-lg border border-dashed border-blue-400 hover:bg-blue-50/50 text-blue-600 font-bold text-xs transition flex items-center justify-center space-x-1 cursor-pointer disabled:opacity-50"
        >
          <span>Auto-fill Operator Credentials</span>
        </button>

        {/* Homeowner portal redirect */}
        <div className="mt-6 pt-4 border-t border-slate-200 flex justify-center text-xs">
          <Link 
            to="/login" 
